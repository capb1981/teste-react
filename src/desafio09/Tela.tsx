...
const nivelSelecionado = "difícil"; // "fácil" | "médio" | "difícil"
const categoriaSelecionada = "react+typescript"; // "react+typescript" | "html" | "Java"
                ...
                <div className="bg-white text-black rounded-lg shadow-md px-6 m-6 w-full text-center lg:w-1/2">
                    {!finalizado ? (
                        ...
                        <div className="text-center">
                            ...
                            <h2 className="text-4x1 font-semibold lg:font-extrabold">
